...
/* ==============================================================================================
                                        全局变量定义
   ============================================================================================== */
// 为之后和菜单打配合准备，本来是要直接设成宏定义的
int16_t L4_WEIGHT = 8;           // 外面灯的权重
int16_t L3_WEIGHT = 5;           // 次外面灯的权重
int16_t L2_WEIGHT = 3;           // 次内部灯的权重
int16_t L1_WEIGHT = 1;           // 内部灯的权重
/* ==============================================================================================
                                        函数定义
   ============================================================================================== */
 ...
 * @return 一个 `int16_t` 值，代表权重后的Error
 */
